      ...
      <div className="relative container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="relative group">
            <div className="h-full p-6 rounded-2xl bg-red-50/50 border border-red-100
              ...
              <h3 className="font-outfit text-lg font-semibold mb-2">Video Analyzer</h3>
              <p className="text-gray-600 mb-4">Get detailed analytics and insights for any YouTube video</p>
              <Link 
