...
export default function PackageCard({ package: pkg, onSelect }: PackageCardProps) {
  ...
  return (
    <div className="relative rounded-lg overflow-hidden transition-all duration-300">
      ...
      <div className="absolute inset-0 bg-white/40 backdrop-blur-[12px] rounded-lg border border-white/20 shadow-sm transition-all duration-300 hover:shadow-md hover:bg-white/60" />
      ...
      <div className="relative p-4">
        ...
        <button
          ...
          className="w-full py-1.5 px-3 bg-red-500 hover:bg-red-600 text-white text-sm 
                     rounded-md transition-colors font-medium relative z-10"
        >
          Select
        </button>
      </div>
